...
class DataSource {
    val generateDrinkList = Resourse.Success(listOf(
        Drink("https://cdn5.recetasdeescandalo.com/wp-content/uploads/2018/09/Coctel-margarita-como-prepararlo.-Receta-e-ingredientes.jpg", "Margartita", "Con azúcar, vodka y nueces"),
